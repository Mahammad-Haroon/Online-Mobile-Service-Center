...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Give Your Feedback Related to Product </h1>
                <div class="row g-4">
                    <!-- <div class="col-12">
                        <div class="row gy-4">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.5s" >
                            ...
                            <form action="controller/feedback.php" method="post">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100 py-3" type="submit" name="postp">Send Feedback</button>
                                    </div>
                                </div>
                            </form>
                        </div>
