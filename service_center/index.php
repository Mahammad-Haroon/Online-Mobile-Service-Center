...
<html lang="en">
  <head>
	...
	<body  style="background-image: url(img/login3.jpg);background-size:cover;">
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
	            	<button type="submit" value="signin" name="signin" class="form-control btn btn-primary submit px-3">Sign In</button>
	            </div>
