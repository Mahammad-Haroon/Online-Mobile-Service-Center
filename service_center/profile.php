...
$sid=$_SESSION['s_id'];
$stmt=$admin->ret("SELECT * FROM `service_center` WHERE `s_id`='$sid'");
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="controller/<?php echo $row['c_profilepic']; ?>" alt="service_center" class="rounded-circle" width="150">
                    <div class="mt-3">
                ...
                <form method="post" action="controller/profile.php" >  
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" value="<?php echo $row['c_name']; ?>" name="c_name" class="form-control">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input type="text"value="<?php echo $row['c_phone'];   ?>" name="c_phone" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input type="text"value="<?php echo $row['c_city'];   ?>"  name="c_city" class="form-control">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input type="text"value="<?php echo $row['c_state'];   ?>"  name="c_state" class="form-control">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input type="text"value="<?php echo $row['c_pin'];   ?>"  name="c_pin" class="form-control">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Adhar Number</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                      <input type="text"value="<?php echo $row['c_adharnumber'];   ?>" name="c_adharnumber" class="form-control">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
