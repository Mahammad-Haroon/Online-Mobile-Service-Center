					  ...
					  <div class="top-menu ms-auto">
						<ul class="navbar-nav align-items-center gap-1">
							...
							<!-- <li class="nav-item dropdown dropdown-app"> -->
								<!-- <a class="nav-link dropdown-toggle dropdown-toggle-nocaret"  href="javascript:;"><i class='bx bx-grid-alt'></i></a> -->
							...
							<!-- <li class="nav-item dropdown dropdown-large"> -->
								<!-- <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" ><span class="alert-count">7</span> -->
							...
							<!-- <li class="nav-item dropdown dropdown-large"> -->
								<!-- <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" role="button" aria-expanded="false"> <span class="alert-count">8</span> -->
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<?php 
											if($row['a_profilepic']==""){
											?>
											<img src="assets/images/Admin.png" alt="Admin" class="user-img" width="110">
											<?php  }
											else{

										?> 
										<img src="controller/<?php echo $row['a_profilepic']; ?>" alt="Admin" class="user-img" style="object-fit:cover;overflow:hidden;">
										<?php } ?>
							<div class="user-info">
								<p class="user-name mb-0 "><?php echo $row['a_name']; ?></p>
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item d-flex align-items-center " href="controller/logout.php"  onclick="return confirm('Are you sure you want to logout?')" ><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>