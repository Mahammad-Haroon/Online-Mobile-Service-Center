...
<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				...
				<div>
					<h4 class="logo-text gig">SmartRepair</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="service_centers.php"><i class='bx bx-radio-circle'></i>Service Centers</a>
						</li>
						<li> <a href="customers.php"><i class='bx bx-radio-circle'></i>Customers</a>
						</li>
				...
				<li>
					<a href="javascript:;" class="has-arrow">
						<div class="2"><i class="fadeIn animated bx bx-map"></i>
						</div>
						<div class="menu-title">Location</div>
					</a>
					<ul>
						<li> <a href="add_location.php"><i class='bx bx-radio-circle'></i>Add Location</a>
						</li>
						<li> <a href="view_location.php"><i class='bx bx-radio-circle'></i>View Location</a>
						</li>
				...
				<li>
					<a href="payments.php" >
						<div class="2"><i class="fadeIn animated bx bx-rupee"></i>
						</div>
				...
				<li>
					<a href="feedback.php" >
						<div class="2"><i class='bx bx-message-square-edit'></i>
						</div>
