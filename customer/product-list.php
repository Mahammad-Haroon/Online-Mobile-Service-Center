                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane fade show p-0 active" style="display:flex;flex-direction:row;flex-wrap:wrap;gap:20px;justify-content:center">
                            <?php
                            $stmt=$admin->ret("SELECT * FROM `product` WHERE `s_id`='$sid' ");
                            ...
                            <div class="card" style="width: 18rem;">
                               ...
                               <div class="card-body">
                                ...
                                <div class="d-flex justify-content-center">
                                  <a class="btn btn-light btn-square me-3 btn-primary" href="update-product.php?pr_id=<?php echo $row['pr_id']; ?>"><i class="bi bi-pencil-square text-light"></i></a>
