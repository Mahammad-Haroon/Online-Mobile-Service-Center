                  ...
                  <div class="job-item p-4 mb-4">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php 
                                        $s=1;
                                        $stmt=$admin->ret("SELECT * FROM `feedback` inner join `client`on client.c_id=feedback.c_id  inner join `student_apply_jobs` on student_apply_jobs.saj_id=feedback.saj_id inner join `jobs` on jobs.j_id=student_apply_jobs.j_id inner join `student`on student.s_id=student_apply_jobs.s_id where student_apply_jobs.s_id='$sid' ");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <img width="30" height="30" style="border-radius:100%;" src="../client/controller/<?php echo $row['c_profile_pic'];?>">&nbsp;&nbsp;<?php echo $row['c_fname'];?> <?php echo $row['c_lname'];?>
                                        </td>
